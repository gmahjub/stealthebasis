...
p("Random Walk w/o Drift\n----------------------\nmean: {:.3f}\nvariance: {:.3f}\nstandard deviation: {:.3f}".format(x.mean(), x.var(), x.std()))
...
p("1st Difference of random walk w/o drift series\n----------------------\nmean: {:.3f}\nvariance: {:.3f}\nstandard deviation: {:.3f}".format(np.diff(x).mean(), np.diff(x).var(), np.diff(x).std()))
p("\n")
_ = tsplot(np.diff(x), lags=30, title='First Diff of Random Walk, No Drift')

p("1st Difference of SPY\n----------------------\nmean: {:.3f}\nvariance: {:.3f}\nstandard deviation: {:.3f}".format(np.diff(ydo_spy.adj_close_px_df.SPY).mean(), np.diff(ydo_spy.adj_close_px_df.SPY).var(), np.diff(ydo_spy.adj_close_px_df.SPY).std()))
p("\n")
_ = tsplot(np.diff(ydo_spy.adj_close_px_df.SPY), lags=30, title='First Diff SPY')

p("Log Returns " + "SPY" + "\n----------------------\nmean: {:.7f}\nvariance: {:.7f}\nstandard deviation: {:.7f}".format(lrets_spy.SPY.mean(), lrets_spy.SPY.var(), lrets_spy.SPY.std()))
p("\n")
...
for t in range(len(w)):
    y[t] = b0 + b1*t + w[t]
p("Linear Model\n----------------------\nmean: {:.3f}\nvariance: {:.3f}\nstandard deviation: {:.3f}".format(y.mean(), y.var(), y.std()))
p("\n")
...
p("AR(2), Alphas=[0.6666,-0.333]\n----------------------\nmean: {:.3f}\nvariance: {:.3f}\nstandard deviation: {:.3f}".format(ar2.mean(), ar2.var(), ar2.std()))
p("\n")
...
p("Log Returns " + symbol_list[0] + "\n----------------------\nmean: {:.7f}\nvariance: {:.7f}\nstandard deviation: {:.7f}".format(lrets[symbol_list[0]].mean(), lrets[symbol_list[0]].var(), lrets[symbol_list[0]].std()))
p("\n")
