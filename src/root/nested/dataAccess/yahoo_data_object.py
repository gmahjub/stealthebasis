...
class YahooDataObject(DataObject):
    ...
    def __init__(self,
        ...
        self.get_px_adj_close = lambda x: web.DataReader(x, 'yahoo', start=self.start_date, end=self.end_date)[
            'Adj Close']
    ...
    def get_all_prices(self):
        ...
        all_px_df = pd.DataFrame(self.get_px_all(self.symbols[0]))
    ...
    def get_adjust_close_prices(self):
        ...
        adj_close_px_df = pd.DataFrame(self.get_px_adj_close(self.symbols[0]))
    ...
    def get_open_prices(self):
        ...
        open_px_df = pd.DataFrame(self.get_px_open(self.symbols[0]))
    ...
    def get_high_prices(self):
        ...
        high_px_df = pd.DataFrame(self.get_px_high(self.symbols[0]))
    ...
    def get_low_prices(self):
        ...
        low_px_df = pd.DataFrame(self.get_px_low(self.symbols[0]))
    ...
    def get_eod_volume(self):
        ...
        volume_df = pd.DataFrame(self.get_volume(self.symbols[0]))
    ...
    def all_from_csv(self):
        ...
        self.all_px_df = pd.read_csv(self.local_data_file_pwd + self.local_all_file_name, parse_dates=['Date'],
                                     index_col='Date')
        self.logger.info("YahooDataObject.all_from_csv(): Dataframe Columns %s ", str(self.all_px_df.columns))

    def adj_close_from_csv(self):

        self.adj_close_px_df = pd.read_csv(self.local_data_file_pwd + self.local_adj_close_file_name,
                                           parse_dates=['Date'], index_col='Date')
        self.logger.info("YahooDataObject.adj_close_from_csv(): Dataframe Columns %s ",
                         str(self.adj_close_px_df.columns))

    def high_from_csv(self):

        self.high_px_df = pd.read_csv(self.local_data_file_pwd + self.local_high_file_name, parse_dates=['Date'],
                                      index_col='Date')

    def low_from_csv(self):

        self.low_px_df = pd.read_csv(self.local_data_file_pwd + self.local_low_file_name, parse_dates=['Date'],
                                     index_col='Date')

    def open_from_csv(self):

        self.open_px_df = pd.read_csv(self.local_data_file_pwd + self.local_open_file_name, parse_dates=['Date'],
                                      index_col='Date')

    def volume_from_csv(self):

        self.volume_df = pd.read_csv(self.local_data_file_pwd + self.local_volume_file_name, parse_dates=['Date'],
                                     index_col='Date')
